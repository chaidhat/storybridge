...
const widgetTypeUploadarea = "uploadarea";

class EditorWidgetUploadarea extends StatelessWidget implements EditorWidget {
  // constructor
  EditorWidgetUploadarea({Key? key, required this.editorWidgetData})
      : super(key: key);
  @override
