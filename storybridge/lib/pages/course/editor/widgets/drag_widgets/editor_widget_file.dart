...
const widgetTypeFile = "file";

class EditorWidgetFile extends StatelessWidget implements EditorWidget {
  // constructor
  EditorWidgetFile({Key? key, required this.editorWidgetData})
      : super(key: key);
  @override
